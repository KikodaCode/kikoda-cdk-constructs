 ...
 *
 * @export
 * @class AssumeRolePartialBuildSpecSpec
 * @typedef {AssumeRolePartialBuildSpecSpec}
 */
export class AssumeRolePartialBuildSpecSpec {
  /**
  ...
  /**
   * Creates an instance of AssumeRolePartialBuildSpecSpec.
   *
   * @constructor
