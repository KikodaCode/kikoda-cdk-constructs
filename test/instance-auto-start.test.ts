...
import { InstanceAutoStart } from '../src';
...
describe('InstanceAutoStop', () => {
  ...
  new InstanceAutoStart(stack, 'InstanceAutoStart', {
    instance,
          ...
          Arn: {
            'Fn::Join': [
              ...
              [
                ...
                '::automation-definition/AWS-StartEC2Instance:$DEFAULT',
              ],
            ],
          },
          ...
          Input: {
            'Fn::Join': [
              ...
              [
                ...
                {
                  'Fn::GetAtt': [
                    Match.stringLikeRegexp('InstanceAutoStartSSMAutomationRole*'),
                    'Arn',
                  ],
                },
                '"]}',
